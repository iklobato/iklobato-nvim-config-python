...
-- Fast cursor movement (optimized with remap)
map("n", "H", "^", { remap = true, desc = "Line start" })
map("n", "L", "$", { remap = true, desc = "Line end" })
map("n", "W", "B", { remap = true, desc = "Word back" })
map("n", "B", "W", { remap = true, desc = "Word forward" })
