...
keymap.set('n', '<leader>E', vim.diagnostic.open_float, { desc = "Show diagnostic (focused)" })
...
-- Equalize window sizes in all tabs (not just current tab)
...
end, { desc = "Make splits equal (all tabs)" })
...
keymap.set("n", "<leader>bc",
  "<cmd>lua require'dap'.set_breakpoint(vim.fn.input('Breakpoint condition: '))<cr>",
  { desc = "Conditional breakpoint" })
keymap.set("n", "<leader>bl",
